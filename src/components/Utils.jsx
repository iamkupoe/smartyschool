export const getCurrentUrl = (url) => {
  ...
  if (current === "" || current === "summary") {
    ...
    current === "profile" ||
    current === "profile/admin-account" ||
    current === "profile/reset-password"
  ) {
    displayUrl = "profile";
  } else if (
    current === "fees" ||
    ...
    current === "reports" ||
    current === "reports/all-reports" ||
    current === "reports/attendance-report"||
    current === "reports/enrollment-report" ||
    current === "reports/performance-report" ||
    current === "reports/payment-report"
  ) {
    displayUrl = "reports";
