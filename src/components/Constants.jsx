...
export const classesAttendance = [
  {
    className: "JHS 1",
    present: 1160,
    absent: 40,
...
export const Registrations = [
  {
...

   {
    id: "2302240938",
    surname: "Commeh",
    otherNames: "Renfred Ekow Haizel",
    stage: "Basic 6",
    transport: true,
    status: "regular",
  },
...
export const reportInfo = [
  {
    ...
    description: "View the attendance report of students for the current term.",
    report_url: "attendance-report",
  },
  {
    title: "Enrollment Report",
    description: "View the enrollment report of students for the current term.",
    report_url: "enrollment-report",
  },
  {
    title: "Performance Report",
    description:
      "View the performance report of students for the current term.",
    report_url: "performance-report",
  },
  {
    title: "Payments Report",
    description: "View the payments report of students for the current term.",
    report_url: "payment-report",
  },
];
